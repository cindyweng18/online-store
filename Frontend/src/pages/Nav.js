...
const Nav = () => {
  ...
  if (user !== null) {
    text = "Welcome, " + user.replace("-", " ");
    link = "/account/" + user;
    display = "";
  };

  // Function that handles log 
  const handleLogout = () => {
    localStorage.clear();
    history.push('/');
  }
    ...
    return (
        ...
        <div className="container-fluid">
          <a className="navbar-brand" href="/">DigiPower PC</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span className="navbar-text">
              <button type="button" className="btn btn-primary" onClick={handleLogout} style={{display: display}}> Logout </button>
            </span>
          </div>
        </div>
      </nav>
